...
public class BookManagement { 
    ...
    static final String DB_URL = "jdbc:postgresql://aws-1-ap-southeast-1.pooler.supabase.com:5432/postgres";
    static final String USER = "postgres.benjzxzulqpyqvatowqf";
    static final String PASSWORD = "hmo6lRVv064QfR94";
